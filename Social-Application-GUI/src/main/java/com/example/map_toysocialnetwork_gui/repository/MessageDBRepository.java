...
public class MessageDBRepository{
    ...
    public MessageDBRepository(UtilizatorDBRepository userRepo) {
    ...
    public void save(Message message) {
        ...
        try (Connection connection = DriverManager.getConnection(DatabaseConnectionConfig.DB_CONNECTION_URL,
             ...
             PreparedStatement statement = connection.prepareStatement("INSERT INTO messages(\"from_user_id\", message, date, reply_id) VALUES " +
                     "(?, ?, ?, ?); ");
        )
        {
