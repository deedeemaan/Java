...
public class UI {
    ...
    public void addUserUI() {
        ...
        serv.add(firstName, lastName,username, password);
    ...
    public void printMenu(){
        ...
        System.out.println("[2] Sterge utilizator existent.");
        System.out.println("[3] Adauga prietenie.");
        System.out.println("[4] Sterge prietenie.");
        System.out.println("[5] Afiseaza prietenii unui utilizator dintr-o anumita luna.");
